...
describe('HttpServiceService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [HttpClient,HttpClientModule,HttpServiceService],
    });
  ...
  describe('#getAllSpaceShuttleDetails', () => {
    let expectedSpaceShuttleList = [];
    beforeEach(() => {
      expectedSpaceShuttleList = [{
        "flight_number": 1,
    ...
    it('should return expected spaceshuttle by calling once', () => {
      service.getSpaceShuttleRecords().subscribe(response =>  expect(response).toEqual(expectedSpaceShuttleList,"should return expectedSpaceShuttleList"),fail
      );
